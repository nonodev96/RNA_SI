...
- 🎯 Entry points to execute your program using `python -m <tfm_sai>` or `$ tfm_sai` with basic CLI argument parsing.
...
```py
from tfm_sai import BaseClass
from tfm_sai import base_function
