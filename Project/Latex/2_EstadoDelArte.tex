...
El \textit{Deep Learning} es una subrama del \textit{machine learning} que usa las redes neuronales artificiales para analizar datos no lineales imitando el comportamiento del cerebro humano, para esto suelen contar con arquitecturas complejas interconectadas con capas de entrada, salida y muchas capas ocultas con distintas funciones de activación que ponderan los pesos de cada neurona. \cite{ibm-deep-learning}

Las redes neuronales profundas tienen multitud de capas con nodos interconectados entre sí cada uno
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{figures/chapter02/GANs.drawio.png}
