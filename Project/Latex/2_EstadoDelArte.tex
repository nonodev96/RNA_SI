...
\begin{itemize}
    ...
    \item[]
        \begin{itemize}
            ...
            \item Algunas de las capas más relevantes para normalización son \texttt{nn.BatchNorm1d} y \texttt{nn.LayerNorm} que permiten aplicar una normalización por lotes o por capas respectivamente.
    ...
    \item[]
        \begin{itemize}
            ...
            \item Incorporan conexiones ciclicas que les permiten propagar información de un paso de tiempo a otro.
            \item Las capas recurrentes tienen memoria y contexto considerando los estados previos, son útiles para traducción de idiomas, procesamiento del lenguaje natural y reconocimiento de voz.
                  % \item Estas capas no permiten paralelización
        \end{itemize}
\end{itemize}
