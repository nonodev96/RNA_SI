...
\begin{figure}[H]
    \centering
    \centerline{\includesvg[width=1\linewidth]{figures/chapter02/fx_optimizer.svg}}
    \caption{Descenso de graidente\\Fuente: \url{https://fxdatalabs.com}{F(x) Data Labs Pvt. Ltd.}}
...
\begin{itemize}
    ...
    \item \textbf{Capas de padding}:
    \item \textbf{Capas de normalización}:
    \item \textbf{Capas recurrentes}:
    \item \textbf{Capas dropout}: Se usan para entrenamientos más estables eliminando dependencias, evitan el sobre entrenamiento, esto lo hacen desactivando de forma estocastica ciertas neuronas en las distintas iteraciones.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Capas convolucionales}
    \item \textbf{Capas reductoras \textit{pooling} y \textit{dropout}}
\end{itemize}
