...
\newglossaryentry{StyleGAN} {name={StyleGAN},   first={Learnable Neural Network architecture with $n$ layers (StyleGAN)},   description={Arquitectura de red neuronal aprendible con $n$ capas}}
%-> Terminos del libro
