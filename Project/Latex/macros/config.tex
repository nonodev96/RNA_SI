...
\def\TituloAbreviado{RNA-SI}

% ==== Introducir aquí el mes y año de presentación del TFG
\def\Fecha{diciembre de 2024}
\def\FechaPortada{diciembre, 2024}
...
% Conjunto de datos 
\newcommand{\mathDataset}[1]{\mathbb{{#1}}}


\newcommand{\GenXtoY}[0]{\underset{X\rightarrow{}Y}{G}}
\newcommand{\GenYtoX}[0]{\underset{Y\rightarrow{}X}{G}}
...
\DefTblrTemplate{contfoot-text}{default}{Continuado en la próxima página}
