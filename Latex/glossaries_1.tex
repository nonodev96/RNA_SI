...
\newglossaryentry{AGI}          {name={AGI},        description={La abreviatura Inteligencia artificial general}}
\newglossaryentry{SDLC}         {name={SDLC},       description={La abreviatura SDLC se refiere en ocasiones al ciclo de vida del desarrollo de sistema}}
...
\newglossaryentry{KDD}          {name={KDD},        description={El KDD viene de las siglas KDD (Knowledge Discovery in Databases), esto es el proceso utilizado para extraer de forma eficiente y automática información \textbf{útil} a partir de grandes volumenes de datos}}
%-> Terminos del libro
...
\newglossaryentry{AI}       {name={AI (Artifical Intelligence)},                    description={Inteligencia Artificial}}
\newglossaryentry{ML}       {name={ML (Machine Learning)},                          description={Machine Learning}}
